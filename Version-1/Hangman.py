...
''')
initiation = input(" PLAY ? (yes or no) ")
while initiation == "yes":
    if initiation != "yes":
        break
    import random
    print("Hello! best of luck!")
 ...
 \/\_____\ \_____\ \_____\    \ \__/".~\_\ \_\ \_\\"\_\ 
  \/_____/\/_____/\/_____/     \/_/   \/_/\/_/\/_/ \/_/ 
      ...
      if guess not in word:
        ...
        print("Wrong")
        if turns != 8:
            print("You have",remaining_guesses_output,"more guesses.")
        if turns == 8:
          print('''
